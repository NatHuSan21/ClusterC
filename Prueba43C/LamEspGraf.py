...
Nprueb = '431C'
denb = 'den15'#'debU'#'den25'#
lim = 25
ValLamb =  0.03 #0.0001 # 0.0075 # 

num_iter = 10000 # 30000 # 


#listaRep = [6,13,16,17,18,24] # 430C [] # 
listaRep = [6,13,24] # 431C
...
fname = ruta + 'SF.csv'
np.savetxt(fname, resData[:,:4], delimiter =",",fmt ='% s')
