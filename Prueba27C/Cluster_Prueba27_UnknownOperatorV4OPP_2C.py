...
for k in listCaid:#25
    ...
    for lam in LAMval:
        ...
        ruta = './restoration/P272C/denoised_P272C_'
        fname = ruta + str(Lambda)  + nameimg 
        out_img_avg_pil.save(fname)

        #Save best image 
        imgPNSRmax_pil = np_to_pil(imgPNSRmax_np)
        fname = './restoration/P272C/BestPnsr_P272C_' + str(Lambda) + nameimg 
    ...
    ruta = './txt272C/'
    name = nameimg.replace('.png','.csv')
    fname = ruta  + 'P272CdenMAXval' + name
