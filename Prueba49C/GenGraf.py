...
namesIMGE2 = np.array(['baboon.png','butterfly.png', 'f16.png', 'leaves.png', 'lena.png', 'parrots.png', 'peppers.png','starfish.png' ])

pritnTab2(resData,namesIMGE2,8)
