...
listaRep =[6]#range(1,15)#[4,6,11,12,15,23]
...
for k in listaRep:#for k in range(1,25):#25#
    ...
    LAMval = [0.0001,0.00025]#[0,0.000001,0.00001,0.00003,0.00005,0.0001,0.00025,0.0005,0.001,0.005,0.0025, 0.03,0.05]
    ...
    for lam in LAMval:
        ...
        full_net =  RiemannianGradientRGB(input_depth, dtype, pad, height=img_height, width= img_width, upsample_mode='bilinear').type(dtype)
